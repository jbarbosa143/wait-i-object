...
myBioObj.address.street = '1234 I dont No';
myBioObj.address.city= 'Groves';
myBioObj.address.state= 'Texas';
...
const randoObj = {
  randoString : 'Take a look at my girlfriend',
  randoBoo : false,
  randoVal : 0123,
  randoRay:[08,675,309],
};
